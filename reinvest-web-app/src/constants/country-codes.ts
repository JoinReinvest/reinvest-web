...
export const COUNTRIES_WITH_CALLING_CODES: CountryWithCallingCode[] = [
  {
    country: 'AG',
    callingCode: '1',
  },
...
export const UNIQUE_COUNTRIES_CALLING_CODES = COUNTRIES_WITH_CALLING_CODES.filter(filterCountriesWithUniqueCallingCodes);
