    ...
    >
      {options.map(({ label, value }) => (
        <RadioGroupItem
          ...
          value={value}
          className={cx(
            'mb-8 px-4 text-11 text-medium uppercase border-b-[2px] border-b-transparent',
            "data-[state='checked']:text-black data-[state='checked']:border-b-black",
            "data-[state='unchecked']:text-gray-light",
          )}
        >
          <p>{label}</p>
        </RadioGroupItem>
